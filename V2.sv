...
- Anchors: headings by their stable prefixed ids; paragraphs and list items by content hash (one `p:` grammar — a list item is a text bit like any other; loose items defer to the paragraphs inside them), computed identically client- and daemon-side.
...
p:3f9c2a1b04d2        a paragraph or list item, by 12-hex content hash
